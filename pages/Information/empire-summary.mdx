...
- **Empire Name and Icon**: Your display name, icon, and public profile that show on the [Scores](/Information/scores) page. You can change your icon and profile text in the [Empire Settings](/settings).
- **Turns**: The number of turns you currently have available to use (and the maximum you are allowed to accumulate).
- **Stored Turns**: The number of turns you have stored in reserve (and the maximum allowed). See the [introduction](/) for more information.
...
- **Money**: The amount of money your empire has on hand, not counting any funds you may have stored in [The Bank](/Finance/the-bank).
...
- **Era**: The [Time Period](/Getting-Started/eras) during which your empire exists.
- **Race**: The [Race](/Getting-Started/races) of your empire's inhabitants.
