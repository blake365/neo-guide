...
All of the actions listed in the "Use Turns" section of the side menu will consume a variable number of turns when you perform them - the [cash](/Using-Turns/cash), [farm](/Using-Turns/farm), [industry](/Using-Turns/industry) and [explore](/Using-Turns/explore) options allow you to specify how much time to spend, while [building](/Using-Turns/build) and [demolishing](/Using-Turns/demolish) consume turns based on how quickly your empire can perform these actions.
